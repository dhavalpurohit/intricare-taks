...
<template>
  ...
  >
    ...
    <div class="layout-content-wrapper">
      ...
      <main class="layout-page-content pa-7 d-flex flex-column flex-grow-1" style="max-inline-size: 100%;">
        <div class="page-content-container pa-6 rounded-lg flex-grow-1 bg-surface">
          <slot />
        </div>
      </main>
